...
class View(models.Model):
    ...
    arch = fields.Text(compute='_compute_arch', inverse='_inverse_arch', string='View Architecture',
                       help="""This field should be used when accessing view arch. It will use translation.
                               Note that it will read `arch_db` or `arch_fs` if in dev_addons-xml mode.""")
    ...
    arch_fs = fields.Char(string='Arch Filename', help="""File from where the view originates.
                                                          Useful to (hard) reset broken views or to read arch from file in dev_addons-xml mode.""")
...
* if False, the view currently does not extend its parent but can be enabled
    ...
    def write(self, vals):
        # Keep track if view was modified. That will be useful for the --dev_addons mode
    ...
    # apply ormcache_context decorator unless in dev_addons mode...
    @api.model
